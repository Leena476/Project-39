...
function draw () {
  ...
  if(gameState === "start"){
    ...
    textFont("georgia");
    fill("white");
    text("Butterfly Migration",5,50);
    
    textSize(20);
    strokeWeight(1);
    fill("blue");
    text("Imagine you are a butterfly who must travel south for the winter.",5,90);
    text("Butterflies face many dangers in their 3,000-mile journey.",5,120);
    text("Predators, such as birds & spiders, are always hunting for prey.",5,150);
    text("Butterflies require nectar from plants, which their energy source.",5,180);
    text("In this game, as a butterfly, you must fly south for the winter.",5,210);
    text("Use the arrow keys to move up, down, left, and right respectively.",5,240);
    text("Be careful! It's dangerous out there. You never know what's coming.",5,270);
    
    textSize(25);
    fill(255);
    strokeWeight(3);
    text("Press the space bar to begin! Have fun! Good luck!",5,320)
